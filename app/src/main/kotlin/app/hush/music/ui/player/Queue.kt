...
import app.hush.music.constants.QueueEditLockKey
...
import app.hush.music.ui.component.MediaMetadataListItem
import app.hush.music.ui.component.TextFieldDialog
import app.hush.music.ui.menu.AddToPlaylistDialog
                ...
                PlayerDesignStyle.V9 -> {
                    if (isLandscape) {
                        ...
                        Column(modifier = Modifier.fillMaxWidth()) {
                            WideLandscapeUpNextBar(
                                nextMetadata = nextUpMetadata,
                                onExpandQueue = openQueue,
                                applyBottomInsets = false,
                            )
                            LandscapeQueueChromeRow(
                                textBackgroundColor = TextBackgroundColor,
                                sleepTimerEnabled = sleepTimerEnabled,
                                sleepTimerTimeLeft = sleepTimerTimeLeft,
                                onExpandQueue = openQueue,
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? app.hush.music.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is app.hush.music.together.TogetherRole.Guest
                                                                if (isGuest) {
