...
import app.hush.music.constants.DailyNightlyReleasesEtagKey
import app.hush.music.constants.DailyNightlyReleasesFingerprintKey
import app.hush.music.constants.DailyNightlyReleasesJsonKey
import app.hush.music.constants.DailyNightlyReleasesLastCheckedAtKey
import app.hush.music.constants.GitHubReleasesEtagKey
import app.hush.music.constants.GitHubReleasesFingerprintKey
import app.hush.music.constants.GitHubReleasesJsonKey
import app.hush.music.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private val canDownloadUpdatesDirectly: Boolean
        get() = BuildConfig.DISTRIBUTION in setOf("gms", "foss")
