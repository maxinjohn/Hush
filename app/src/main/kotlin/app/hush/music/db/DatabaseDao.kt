...
import app.hush.music.db.entities.AlbumArtistMap
...
import app.hush.music.db.entities.LibraryTopMixEntity
import app.hush.music.db.entities.LibraryTopMixSongMap
import app.hush.music.db.entities.ListeningBySlot
import app.hush.music.db.entities.ListeningTotals
import app.hush.music.db.entities.LyricsEntity
import app.hush.music.db.entities.PlayCountEntity
import app.hush.music.db.entities.Playlist
import app.hush.music.db.entities.PlaylistEntity
import app.hush.music.db.entities.PodcastEntity
import app.hush.music.db.entities.PlaylistPlayCount
import app.hush.music.db.entities.PlaylistSong
import app.hush.music.db.entities.PlaylistSongMap
import app.hush.music.db.entities.PlaylistTagMap
import app.hush.music.db.entities.PlaylistWithTags
import app.hush.music.db.entities.RelatedSongMap
import app.hush.music.db.entities.SearchHistory
import app.hush.music.db.entities.SetVideoIdEntity
import app.hush.music.db.entities.Song
import app.hush.music.db.entities.SongAlbumMap
import app.hush.music.db.entities.SongArtistMap
import app.hush.music.db.entities.SongEntity
import app.hush.music.db.entities.SongWithStats
import app.hush.music.db.entities.TagEntity
import app.hush.music.extensions.reversed
import app.hush.music.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    @Transaction
    @Query("SELECT * FROM song WHERE inLibrary IS NOT NULL OR isLocal = 1 ORDER BY rowId")
