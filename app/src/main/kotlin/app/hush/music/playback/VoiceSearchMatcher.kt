/*
 * Hush — voice search matching (ported from Metrolist, GPL-3.0)
 */
...
object VoiceSearchMatcher {
    ...
    private fun scoreCandidate(
        ...
        if (remaining.isEmpty()) return 0.5
    ...
    private fun stripArtistTokens(queryTokens: Set<String>, song: Song): Set<String> {
        ...
        song.artists.forEach { artist ->
            ...
            remaining.removeIf { queryToken ->
                ...
                else artistTokens.any { artistToken -> jaroWinkler(queryToken, artistToken) >= FUZZY_THRESHOLD }
            }
        }
        return remaining
    }
    ...
    private fun fuzzyScore(queryTokens: Set<String>, titleTokens: Set<String>): Double {
        ...
        return if (titleCoverage + queryCoverage > 0)
            (2.0 * titleCoverage * queryCoverage) / (titleCoverage + queryCoverage)
        else 0.0
    }
