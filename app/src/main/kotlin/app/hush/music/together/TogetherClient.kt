...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: app.hush.music.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: app.hush.music.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: app.hush.music.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is app.hush.music.together.JoinDecision -> {
                            ...
                            is app.hush.music.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
