...
import moe.rukamori.archivetune.constants.DefaultLyricsProviderOrder
...
@Composable
fun lyricsAnimationStyleLabel(style: moe.rukamori.archivetune.constants.LyricsAnimationStyle): String =
    when (style) {
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.NONE -> stringResource(R.string.none)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.FADE -> stringResource(R.string.fade)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.GLOW -> stringResource(R.string.glow)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.SLIDE -> stringResource(R.string.slide)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.KARAOKE -> stringResource(R.string.karaoke)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.APPLE -> stringResource(R.string.apple_music_style)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.APPLE_V2 -> stringResource(R.string.apple_music_style_letter)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.HUSH_FLUID -> stringResource(R.string.hush_music_fluid)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.LYRICS_V2 -> stringResource(R.string.lyrics_v2_fluid)
        moe.rukamori.archivetune.constants.LyricsAnimationStyle.METRO_LYRICS -> stringResource(R.string.lyrics_animation_metro)
    }
