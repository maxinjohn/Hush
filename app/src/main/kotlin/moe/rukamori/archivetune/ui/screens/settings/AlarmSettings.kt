...
import moe.rukamori.archivetune.playback.alarm.MusicAlarmEntry
import moe.rukamori.archivetune.playback.alarm.MusicAlarmScheduler
import moe.rukamori.archivetune.playback.alarm.MusicAlarmStore
import moe.rukamori.archivetune.ui.component.DefaultDialog
import moe.rukamori.archivetune.ui.component.IconButton as HushIconButton
import moe.rukamori.archivetune.ui.component.PreferenceEntry
import moe.rukamori.archivetune.ui.component.PreferenceGroup
import moe.rukamori.archivetune.ui.utils.backToMain

@Composable
fun AlarmSettings(navController: NavController) {
    Column(
        Modifier
            .windowInsetsPadding(
...
fun AlarmSettingsContent() {
    ...
    PreferenceGroup(title = stringResource(R.string.alarm)) {
        item {
            PreferenceEntry(
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S && !canScheduleExact) {
        PreferenceGroup(title = stringResource(R.string.alarm_exact_permission_title)) {
            item {
                PreferenceEntry(
                    title = { Text(stringResource(R.string.alarm_exact_permission_title)) },
                    description = stringResource(R.string.alarm_exact_permission_desc),
    ...
    if (!ignoringBatteryOptimization) {
        PreferenceGroup(title = stringResource(R.string.alarm_battery_optimization_title)) {
            item {
                PreferenceEntry(
                    title = { Text(stringResource(R.string.alarm_battery_optimization_title)) },
                    description = stringResource(R.string.alarm_battery_optimization_desc),
                    icon = { Icon(painterResource(R.drawable.info), null) },
                    onClick = {
                        try {
...
private fun AlarmEditorDialog(
    ...
    val hasSameTimeAlarm =
        remember(hour, minute, existing, allAlarms) {
