...
import app.hush.music.lastfm.models.LastFmError
import app.hush.music.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "Hush (https://github.com/ArchiveTuneApp/ArchiveTune)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
