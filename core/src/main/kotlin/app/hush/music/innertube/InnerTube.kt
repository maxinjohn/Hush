...
import app.hush.music.innertube.models.Context
import app.hush.music.innertube.models.IpVersion
import app.hush.music.innertube.models.MediaInfo
import app.hush.music.innertube.models.ReturnYouTubeDislikeResponse
import app.hush.music.innertube.models.YouTubeClient
import app.hush.music.innertube.models.YouTubeLocale
import app.hush.music.innertube.models.body.*
import app.hush.music.innertube.models.response.NextResponse
import app.hush.music.innertube.proxy.RotatingProxySelector
import app.hush.music.innertube.utils.sha1
import app.hush.music.innertube.utils.youtubeLoginCookieValue
import okhttp3.Dns
...
class InnerTube {
    ...
    private fun createClient() =
        HttpClient(OkHttp) {
            ...
            engine {
                config {
                    dns(this@InnerTube.dns.withIpVersionPreference(ipVersion))
                    ...
                    if (sel != null) {
                        ...
                        proxyAuthenticator { _, response ->
                            val username = proxyUsername ?: return@proxyAuthenticator response.request
                            val password = proxyPassword ?: return@proxyAuthenticator response.request
