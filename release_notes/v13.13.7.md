...
- **Waze shim zip sync** — rebuilt and synced `waze-shims.zip` in both `main/assets` and `mobile/assets`. *(Hush)*

## Housekeeping

- Version bumped to 13.13.7 (versionCode 168, app + waze-shim). *(Hush)*
